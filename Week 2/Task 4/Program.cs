...
namespace Task_4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (!File.Exists (sfile)) { // if the source file exists, then create a new file with the text "$file_name$ + was created"
        ...
        static void show (DirectoryInfo x) { // used this function to print a directory content for testing. Not used in main function
