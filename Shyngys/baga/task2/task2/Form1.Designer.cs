namespace task2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(35, 136);
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(484, 136);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(69, 72);
			...
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(326, 114);
			...
			this.button7.Paint += new System.Windows.Forms.PaintEventHandler(this.button2_Paint);
			// 
			// button8
			// 
			this.button8.Location = new System.Drawing.Point(79, 237);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(69, 72);
			this.button8.TabIndex = 7;
			this.button8.Text = "button8";
			this.button8.UseVisualStyleBackColor = true;
			this.button8.Click += new System.EventHandler(this.button2_Click);
			this.button8.Paint += new System.Windows.Forms.PaintEventHandler(this.button2_Paint);
			// 
			// button9
			// 
			this.button9.Location = new System.Drawing.Point(362, 237);
			this.button9.Name = "button9";
			this.button9.Size = new System.Drawing.Size(69, 72);
			this.button9.TabIndex = 8;
			this.button9.Text = "button9";
			this.button9.UseVisualStyleBackColor = true;
			this.button9.Click += new System.EventHandler(this.button2_Click);
			this.button9.Paint += new System.Windows.Forms.PaintEventHandler(this.button2_Paint);
			// 
			// button10
			// 
			this.button10.Location = new System.Drawing.Point(175, 158);
			this.button10.Name = "button10";
			this.button10.Size = new System.Drawing.Size(69, 72);
			this.button10.TabIndex = 9;
			this.button10.Text = "button10";
			this.button10.UseVisualStyleBackColor = true;
			this.button10.Click += new System.EventHandler(this.button2_Click);
			this.button10.Paint += new System.Windows.Forms.PaintEventHandler(this.button2_Paint);
			// 
			// Form1
			// 
